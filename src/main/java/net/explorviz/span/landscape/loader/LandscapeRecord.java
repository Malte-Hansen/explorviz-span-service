...
public record LandscapeRecord(
    ...
    public static LandscapeRecord fromRow(Row row) {
        ...
        return new LandscapeRecord(
            landscapeToken, methodHash, nodeIpAddress, applicationName, applicationLanguage, applicationInstance,
            packageName, className, methodName, timeSeen
        );
    }
}
